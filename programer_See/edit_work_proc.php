    ...
    case 0:
      // echo "派工";
		//exit();
				...
				//自動發信
					$alert_written_time = trim($_POST['alert_written_time']);
				//首回復
					$Processing_time_A = trim($_POST['Processing_time_A']);
					$note_A = trim($_POST['note_A']);
					$Processor_A = trim($_POST['Processor_A']);
