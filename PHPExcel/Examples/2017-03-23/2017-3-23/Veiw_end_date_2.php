...
while ($row  = mysql_fetch_assoc($result))
{
		...
		if($x=='11')
		{
			$Arrray[$i][1111]=$row['Equipment_Repair_time'];
		}else{
			$Arrray[$i][1111]=''; //已發信
		}
		...
		if($x=='12')
		{
			$Arrray[$i][1112]=$row['Equipment_Repair_time'];
		}else{
			$Arrray[$i][1112]=''; //首回覆
		}
		...
		if($x=='00')
		{
			$Arrray[$i][1100]=$row['Equipment_Repair_time'];
		}else{
			$Arrray[$i][1100]=''; //已派工
		}
		...
		if($x=='01')
		{
				...
				{
				$Arrray[$i][1101]=$row['Equipment_Repair_time'];
				}else{
				$Arrray[$i][1101]=$row['TIIS_Maintenance_arrival_time'];
				}
		...
		if($x=='02')
		{
			$Arrray[$i][1102]=$row['Equipment_Repair_time'];
		}else{
			$Arrray[$i][1102]=''; //處理中
		}
		...
		if($x=='03')
		{
			$Arrray[$i][1103]=$row['Equipment_Repair_time'];
		}else{
			$Arrray[$i][1103]=''; //已結案
		}
		...
		//$Arrray[$i][12]='TIIS_Processing_end_time空白';
		$Arrray[$i][13]='';
...
while ($row1  = mysql_fetch_assoc($result1))
{
		...
		$Arrray[$i][1112]=='';
		$Arrray[$i][1100]=='';
		$Arrray[$i][1101]=$row1['TIIS_Maintenance_arrival_time'];
		$Arrray[$i][1102]=='';
		$Arrray[$i][1103]=$row1['TIIS_Processing_end_time'];
		//
		$Arrray[$i][10]=$row1['TIIS_Called_repair_category'];
