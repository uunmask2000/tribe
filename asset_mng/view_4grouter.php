...
//echo  $sql4;
				...
				<tr>
					...
					<td><?=	$ass_4Gname;?></td>
					<td><a href="fix_4grouter.php?LONG_TXT=<?=$LONG_TXT ;?>&id=<?=$ass_4Ggrouter_id;?>"><img src="../images/icon_edit.png" class="adm_icon" align="absmiddle"></a></td>
					<td><a href="change_4grouter.php?LONG_TXT=<?=$LONG_TXT ;?>&LONG_TXT2=<?=$LONG_TXT2 ;?>&id=<?=$ass_4Ggrouter_id;?>"><img src="../images/icon_change.png" class="adm_icon" align="absmiddle"></a></td>
