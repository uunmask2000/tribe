...
//echo  $sql4;
				...
				<tr>
					...
					<td><a href="fix_poesw.php?LONG_TXT=<?=$LONG_TXT ;?>&id=<?=$ass_poesw_id;?>"><img src="../images/icon_edit.png" class="adm_icon" align="absmiddle"></a></td>
					<td><a href="change_poesw.php?LONG_TXT=<?=$LONG_TXT ;?>&LONG_TXT2=<?=$LONG_TXT2 ;?>&id=<?=$ass_poesw_id;?>"><img src="../images/icon_change.png" class="adm_icon" align="absmiddle"></a></td>
