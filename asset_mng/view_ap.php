	...
	<div id="main">
		...
		<div class="tab_container">
			...
			<table cellpadding="0" cellspacing="0" class="bar">
				<tr>
				<td width="200"><a class="add" href="insert_ap.php" targer="_self" >新增資產</a></td>
			<td align="right">
...
if($A>0)
	{
	//$sql4 = "SELECT * FROM `ass_ap` where ass_ap_label	 ='$A' ";
	//echo '未選擇部落';
	if($Doube_label_tribe>0 )
		{
		$sql4 = "SELECT * FROM `ass_ap` where ass_ap_tribe='$Doube_label_tribe' ";	
		}
	}else{
		if($city>0 ){
...
//echo  $sql4;
					...
					while ($row4 = mysql_fetch_assoc($result4) )
					{
						...
						$IP =$row4['ass_ap_ip'];
						////
						$ass_ap_sn =$row4['ass_ap_sn'];
						$ass_ap_mac =$row4['ass_ap_mac'];
						$ass_ap_pn =$row4['ass_ap_pn'];
						?>
				<tr>
					...
					<td><?=	$ass_ap_name;?></td>
					<td><a href="fix_ap.php?LONG_TXT=<?=$LONG_TXT ;?>&id=<?=$ass_ap_id;?>" target="blank"><img src="../images/icon_edit.png" class="adm_icon" align="absmiddle"></a></td>
					<td><a href="change_ap.php?LONG_TXT=<?=$LONG_TXT ;?>&LONG_TXT2=<?=$LONG_TXT2 ;?>&id=<?=$ass_ap_id;?>" target="blank"><img src="../images/icon_change.png" class="adm_icon" align="absmiddle"></a></td>
					
					<td>
					<a href="javascript:if(confirm('確定要刪除嗎?'))location='?mode=del_grouter&id=<?=$ass_ap_id;?>'"><img src="../images/icon_del.png" class="adm_icon" align="absmiddle"></a>
					</td>
					<td>
					<?php
					...
					<td  style="display: none;"><?=	$IP;?></td>
					<td  style="display: none;"><?=	$ass_ap_sn;?></td>
					<td  style="display: none;"><?=	$ass_ap_mac;?></td>
					<td  style="display: none;"><?=	$ass_ap_pn;?></td>
				</tr>
