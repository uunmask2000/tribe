...
<?php         //  echo       $string =  $B.'-'.$B1.'-'.$B11.'-'.$B111.'-'.$_POST['view_num'];        ?>
	...
	$result4= execute_sql($database_name, $sql4, $link);
				...
				<tr>
					...
					<td><?=	$ass_name;?></td>
					<td><a href="fix_fw.php?LONG_TXT=<?=$LONG_TXT ;?>&id=<?=$ass_grouter_id;?>"><img src="../images/icon_edit.png" class="adm_icon" align="absmiddle"></a></td>
					<td><a href="change_fw.php?LONG_TXT=<?=$LONG_TXT ;?>&LONG_TXT2=<?=$LONG_TXT2 ;?>&id=<?=$ass_grouter_id;?>"><img src="../images/icon_change.png" class="adm_icon" align="absmiddle"></a></td>
