...
//echo $z;
            $sql ="INSERT INTO TX_and_Rx(data_interval, time_zone, zone, radio, timestamp, ssid_itaiwan, itaiwan_rx, itaiwan_tx, itaiwan_itribe, itribe_rx, itribe_tx) VALUES
...
//echo $z;
            $sql ="INSERT INTO TX_and_Rx(data_interval, time_zone, zone, radio, timestamp, ssid_itaiwan, itaiwan_rx, itaiwan_tx, itaiwan_itribe, itribe_rx, itribe_tx) VALUES
('$AAAA[0]','$BBBB[0]','$CCCC[$z1]','$DDDD[1]','$data[0]','$EEEE[1]','$data[$z1]','$data[$z2]','$EEEE[3]','$data[$z3]','$data[$z4]')";
$result = execute_sql($database_name, $sql, $link);
echo   $sql;
