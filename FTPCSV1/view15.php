...
//echo 'Ssid:iTaiwan';
 $sql ="INSERT INTO TX_and_Rx_5G(data_interval_5G, time_zone_5G, zone_5G, radio_5G, timestamp_5G, ssid_itaiwan_5G, itaiwan_rx_5G, itaiwan_tx_5G, ssid_itribe_5G itribe_rx_5G, itribe_tx_5G) VALUES
...
$sql ="INSERT INTO TX_and_Rx_5G(data_interval_5G, time_zone_5G, zone_5G, radio_5G, timestamp_5G, ssid_itribe_5G , itribe_rx_5G, itribe_tx_5G, ssid_itaiwan_5G, itaiwan_rx_5G, itaiwan_tx_5G) VALUES
('$AAAA[0]','$BBBB[0]','$CCCC[1]','$DDDD[1]','$data[0]','$EEEE[1]','$data[1]','$data[2]','$EEEE[3]','$data[3]','$data[4]')";
$result = execute_sql($database_name, $sql, $link);
