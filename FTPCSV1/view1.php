...
$result = execute_sql($database_name, $sql, $link);
 ...
 $sql = "INSERT INTO Client_Number(Client_Number_data, Client_Number_time, timestamp, Client_Number_zone, Client_Number_radio, ssid_itribe, ssid_itribe_max_client, ssid_itribe_min_client, ssid_itaiwan, ssid_itaiwan_max_client, ssid_itaiwan_min_client)
VALUES ('$AAAA[0]','$BBBB[0]','$data[0]','$CCCC[1]','$DDDD[1]','$EEEE[1]','$data[1]','$data[2]','$EEEE[3]','$data[3]','$data[4]')";
$result = execute_sql($database_name, $sql, $link);
