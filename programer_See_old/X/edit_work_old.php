...
if($Processing_status=='已發信')
{
	echo '只能首回覆';
	?>
	<p><a class='inline_mail' href="#inline_content_mail">首回覆</a></p>
...
if($Processing_status=='首回覆')
{
	...
	//echo '只能派工';
	?>
	<p><a class='inline_A' href="#inline_content_A">派工</a></p>
...
if($Processing_status=='已派工' or $Processing_status=='已到達' or $Processing_status=='處理中')
{
	...
	//echo '能 已到達  處理中  結案 ';
	?>
				<p><a class='inline_B' href="#inline_content_B">到達</a></p>
				<p><a class='inline_C' href="#inline_content_C">處理</a></p>
				<?php
				if($num_rows > 1)
				{
					?>
					<p><a class='inline_D' href="#inline_content_D">結案</a></p>
					<?php
				}
				?>
