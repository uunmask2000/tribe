...
<script language="javascript">setTimeout("self.opener = null; self.close();",60000)</script>
		...
		if($_GET['mode']=='do')
		{
			...
			$sql = "UPDATE  Equipment_Repair SET time='$time',Equipment_Repair_remark='$Equipment_Repair_remark', accendant='$accendant' WHERE Equipment_Repair_id='$key' ";
...
派工時間  <input  type="text"  name="time"  value="<?=$Equipment_Repair_time ;?>"/> PS 格式為 0000-00-00 00:00:00  <br>
	指派工程師
