...
.tribe_name, .dis_time, .proc_num, .fix_num, .proc_status { font-size:1.2em;}
...
echo '<div class="tribe_name">'.$alert_ap_date_city .$alert_ap_date_township .$alert_ap_date_tribe .$alert_ap_date_ap_name .'</div>
<div class="dis_time">服務中斷時間: ' .$alert_written_time  .'</div>';
echo '<div class="proc_num">處理編號:'.$calling_bar_id.'</div>';
echo '<div class="fix_num">叫修編號:'.$alert_ap_date_filter_id.'</div>';
