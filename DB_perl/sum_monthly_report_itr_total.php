...
{							
$id = $row['monthly_report_itr_total_id'];

//UPDATE
$sql3 = "UPDATE `monthly_report_itr_total` SET device_number='$device_number', Use_of_people ='$number1',Number_of_users ='$number2',Total_usage_time ='$acctsessiontime',Upload_traffic ='$acctinputoctets',Download_traffic ='$acctoutputoctets',filter_number ='$num_rows' where monthly_report_itr_total_id ='$id '  ";  //monthly_report_itr_total_id
