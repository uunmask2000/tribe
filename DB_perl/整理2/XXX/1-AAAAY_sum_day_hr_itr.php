...
while ($row_t = mysql_fetch_array($result_t))
{
	...
	for($tt=0 ; $tt <92 ;$tt++)
	{
				...
				$sql_sum = "SELECT SUM(acctinputoctets),SUM(acctoutputoctets) FROM radacct  where nasipaddress IN ('$ass_ap_ip') and  realm<>'itw'  and acctstarttime like '%$time_string%' ";
				...
				$sum_day_hr_itr_id = mysql_result($result31, 0, "sum_day_hr_itr_id");
