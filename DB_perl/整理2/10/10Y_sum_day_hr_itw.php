	...
	for($tt=0 ; $tt <32 ;$tt++)
	{
			for($t=0 ; $t <24 ;$t++)
			{
			   ...
			   ?>
						...
						$sql_sum = "SELECT SUM(acctinputoctets),SUM(acctoutputoctets) FROM radacct  where nasipaddress IN ('$ass_ap_ip') and  realm<>'0'  and acctstarttime like '%$time_string%' and radacctid >='$MIX_ID' and radacctid <='$MAX_ID'  ";
