...
date_default_timezone_set('Asia/Taipei');
 $a_time_sater1	 = date("Y-m-d H", strtotime( "-8 hour" ));
	...
	if($A2 < $D)
	{
		//echo $D ;
			...
			$mail->AddAttachment("", "");		
					...
					//$mail->AddAddress('seanchen@tiis.com.tw','seanchen'); //東宜
					//$mail->AddAddress('frankchang@tiis.com.tw','Frank');  //東宜
					//$mail->AddAddress('danielwu@tiis.com.tw','Daniel');   //總PM收件者信箱
					$mail->AddAddress('yashon@tecom.com.tw','Yashon');
					//$mail->AddAddress('heaven@fareastone.com.tw','Heaven');  //遠傳
					//$mail->AddAddress('chhsfang@fareastone.com.tw','Chhsfang');	//遠傳			
