							...
							$Download_traffic= ceil($Download_traffic);
										...
										*/
										...
										<td><?php
												...
												?>	</td>
										<td>
										<a href="report_web.php?mode=case_E&tribe_sid=<?=$tribe_sid;?>&realm=愛部落/愛台灣&tribe_name=<?=$tribe ;?>" target="_blank">
<img src="https://cdn0.iconfinder.com/data/icons/woocons1/Chart.png"></a>
				...
				?>
						...
						}else if($realm =='itr')
						{
							...
							?>
							<td align="center">
<a href="report_web.php?mode=case_E&tribe_sid=<?=$tribe_sid;?>&realm=愛部落&tribe_name=<?=$tribe ;?>" target="_blank">
<img src="https://cdn0.iconfinder.com/data/icons/woocons1/Chart.png"></a>
</td>	
						...
						}else if($realm =='itw')
						{
							...
							?>
<td align="center">
<a href="report_web.php?mode=case_E&tribe_sid=<?=$tribe_sid;?>&realm=愛台灣&tribe_name=<?=$tribe ;?>" target="_blank">
<img src="https://cdn0.iconfinder.com/data/icons/woocons1/Chart.png"></a>
</td>							
							</tr>
							<?php
