				...
				echo '<tr>';
					...
					{ 
						...
						//各設備斷線資料總數
							...
							<td align="center">
							<a href="report_web.php?mode=case_E&ip=<?=$ass_ap_ip;?> &tribe_name=<?=$tribe_name;?>&label=<?=$label_tribe;?>&apname=<?=$ass_ap_name;?>">
...
$(document).ready(function(){ 
  var opt={ "oLanguage":{"sProcessing":"處理中...",
			 ...
			 [
				...
				{ extend: 'print', text: '列印',title: '<?= date("Y-m-d");?> <?=$filename;?>  熱點服務效益分析明細表' },	
				'pageLength',				
			],
	   };
