...
//echo  $sql4;
				...
				<tr>
					...
					<td><a href="show_pdu.php?ip=<?=$row4['ass_pdu_ip'];?>"><img src="../images/icon_magnifier.png" class="adm_icon" align="absmiddle"></a>
					<td>
					<?php
   ...
   <script language="JavaScript">
    $(document).ready(function(){ 
      var opt={ "oLanguage":{"sProcessing":"處理中...",
			...
			// dom: 'Bfrtip',	 buttons: [									{ extend: 'excelHtml5', text: '匯出試算表', title: 'PDU 統計表' },									{ extend: 'print', text: '列印' , title: 'PDU統計表'},								],
	       };
