...
//echo  $sql4;
					...
					while ($row4 = mysql_fetch_assoc($result4)  )
					{
						...
						$ass_poesw_ip =  $row4['ass_poesw_ip'];
				...
				<tr>
					...
					<td><a href="show_poe_sw.php?ip=<?=$row4['ass_poesw_ip'];?>"><img src="../images/icon_magnifier.png" class="adm_icon" align="absmiddle"></a>
					<td>
					<?php
   ...
   <script language="JavaScript">
    $(document).ready(function(){ 
      var opt={ "oLanguage":{"sProcessing":"處理中...",
				...
				// dom: 'Bfrtip',	 buttons: [									{ extend: 'excelHtml5', text: '匯出試算表', title: 'PoE Switch 統計表' },									{ extend: 'print', text: '列印' , title: 'PoE Switchr 統計表'},						],
	       };
