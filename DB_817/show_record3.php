...
<!-------------------------------------- MAIN -->
    ...
    <?php
      ...
      //執行 SQL 命令
      //$sql = "SELECT *  FROM radacct where nasipaddress='172.21.150.101' ORDER BY acctsessiontime DESC";
	//	$sql = "SELECT *  FROM radacct  where acctstoptime  <>'0000-00-00 00:00:00' ORDER BY acctstoptime desc";
//$sql = "SELECT * FROM `radacct` WHERE `radacctid` >577280 and acctstoptime  <>'0000-00-00 00:00:00' and acctstoptime < '2016-10-29 00:00:00' ";			
