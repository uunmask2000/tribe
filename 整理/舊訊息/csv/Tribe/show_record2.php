<html>
  <head>
    ...
    <title>Client_Number_Vs_Air_Time</title>
  </head>
  <body>
    <h1 align="center">Client_Number_Vs_Air_Time</h1>
    <?php
      ...
      else
	{
      ...
      //執行 SQL 命令
      $sql = "SELECT  `zone`, `radio`, `timestamp`, `of_clients`, `tx`, `rx`, `busy` FROM `Client_Number_Vs_Air_Time`ORDER BY timestamp DESC";	
