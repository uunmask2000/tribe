<html>
  <head>
    ...
    <title>Failed_Client_Associations</title>
  </head>
  <body>
      ...
      else
	{
      ...
      //執行 SQL 命令
      $sql = "SELECT `zone`, `radio`, `timestamp`, `ssid_itaiwan`, `itaiwan_fail_ass` FROM `Failed_Client_Associations` ORDER BY timestamp DESC";	
