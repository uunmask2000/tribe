<html>
  ...
  <body>
      ...
      else
	{
      ...
      //執行 SQL 命令
      $sql = "SELECT  `timestamp`, `Client_Number_zone`, `Client_Number_radio`, `ssid_itaiwan`, `ssid_itaiwan_max_client`, `ssid_itaiwan_min_client` FROM Client_Number  ORDER BY timestamp DESC";	
