<html>
  <head>
    ...
    <title>new_Client_Associations</title>
  </head>
  <body>
      ...
      else
	{
      ...
      //執行 SQL 命令
      $sql = "SELECT `time_zone`, `zone`, `radio`, `timestamp`, `ssid_itaiwan`, `itaiwan_fail_ass` FROM `new_Client_Associations` ORDER BY timestamp DESC";	
