<html>
  <head>
    ...
    <title>new_Client_Associations_5G</title>
  </head>
  <body>
      ...
      else
	{
      ...
      //執行 SQL 命令
      $sql = " SELECT `zone_5G`, `radio_5G`, `timestamp_5G`, `ssid_itaiwan_5G`, `itaiwan_max`, `itaiwan_min` FROM `new_Client_Associations_5G` ORDER BY timestamp_5G DESC";	
