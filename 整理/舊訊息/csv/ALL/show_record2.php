<html>
  <head>
    ...
    <title>Continuously_Disconnected_APs</title>
  </head>
  <body>
    <h1 align="center">Continuously_Disconnected_APs/h1>
    <?php
      ...
      else
	{
      ...
      //執行 SQL 命令
      $sql = "SELECT * FROM `Continuously_Disconnected_APs`  ORDER by lastseen desc";	
