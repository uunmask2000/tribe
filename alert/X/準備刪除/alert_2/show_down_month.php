		...
		<div id="content0">
			<div id="port_data">
				<table  id="show_date"  class="alert_tb">
					...
					echo '<div class="alert_tt">目前斷線數量:'.$total_records.'數' ;
					 ...
					 if($total_ap>0 or  $total_router >0 or  $total_4G_router >0 or $total_PDU >0 or  $total_poesw >0)
					 {
						 while ($row_ap = mysql_fetch_assoc($result_ap))
																{																	  
																	  ...
																	  ?>
																	  <td><a href="../device_defend/show_all_device.php?key=<?=$row_ap['ass_ap_tribe'];?>" target="_blank"><?=$row_ap['tribe_name'];?></a></td>
																...
																while ($row_router = mysql_fetch_assoc($result_router))
																{
																	 // echo $row_router['ass_name']; ass_grouter_city
																	  ?>
																	  <td><a href="../device_defend/show_all_device.php?key=<?=$row_router['ass_grouter_city'];?>" target="_blank"><?=$row_router['tribe_name'];?></a></td>
																...
																while ($row_4G_router = mysql_fetch_assoc($result_4G_router))
																{
																	 // echo $row_4G_router['ass_4Gname']; ass_4Ggrouter_tribe
																	  ?>
																	  <td><a href="../device_defend/show_all_device.php?key=<?=$row_4G_router['ass_4Ggrouter_tribe'];?>"><?=$row_4G_router['tribe_name'];?></a></td>
																...
																while ($row_PDU = mysql_fetch_assoc($result_PDU))
																{
																	...
																	?>
																	 <td><a href="../device_defend/show_all_device.php?key=<?=$row_PDU['ass_pdu_tribe'];?>" target="_blank"><?=$row_PDU['tribe_name'];?></a></td>
																...
																while ($row_poesw = mysql_fetch_assoc($result_poesw))
																{
																	 // echo $row_poesw['ass_poesw_name']; ass_poesw_tribe
																	  ?>
																	  <td><a href="../device_defend/show_all_device.php?key=<?=$row_poesw['ass_poesw_tribe'];?>" target="_blank"><?=$row_poesw['tribe_name'];?></a></td>
...
$(document).ready(function(){ 
  var opt={ "oLanguage":{"sProcessing":"處理中...",
		...
		dom: 'Bfrtip',	 buttons: [
				{ extend: 'excelHtml5', text: '匯出斷線數量統計表(當前)' ,title: '<?= date("Y-m-d");?>斷線數量統計表' },
