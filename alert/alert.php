	...
	<div id="abgne_marquee">
		<div class="marquee_btn" id="marquee_next_btn"><img src="../images/marquee_next_btn.jpg"></div>
				<ul style="top: -55px;">
						...
						$sql_text ="SELECT A.iflostservice,C.ipaddr,D.eventlogmsg FROM outages  as A
									join ifservices  as B  on  A.ifserviceid = B.id 
									join ipinterface  as C on  B.ipinterfaceid = C.id
									join events  as D   on A.svclosteventid = D.eventid 
						...
						//echo date_format($date,"Y-m-d H:i:s");	
							$ip = $row[1];
							$msg = $row[2];
							$msg =  str_replace ("Node","",$msg);
							$msg =  str_replace ("is down.","服務中斷中...",$msg);
?>
<li><a href="../alert/check_alert_ip_type.php?ip=<?=$ip;?>" target="_blak"> 時間: <?php echo date_format($date,"Y-m-d H:i:s");?> 訊息:<?php echo $msg ;?>  </a></li>			
<?php
						}
						?>
