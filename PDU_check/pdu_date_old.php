...
<?php
			...
			$link = create_connection();
				...
				while ($row_PDU= mysql_fetch_assoc($result_PDU)  )
				{
					...
					//echo '這是第一行<br>';
					 echo '<iframe src="pdu_date_form.php?tribe_name='.$tribe_name.'&ip='.$ass_pdu_ip.'"  width="180" height="80" marginwidth="0" marginheight="0" scrolling="no" frameborder="3" align="center"  ></iframe>';
